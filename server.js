...
(async () => {
  ...
  // One-time correction: 70121 / 70123 are Jefferson Parish (River Ridge / Jefferson
  // CDP / Harahan) but were previously mislabeled Orleans. Self-cleaning (idempotent).
  await pool.query("UPDATE rsvps SET parish='Jefferson' WHERE zip IN ('70121','70123') AND parish='Orleans'");
